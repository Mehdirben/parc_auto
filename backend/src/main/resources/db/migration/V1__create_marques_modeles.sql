...
CREATE TABLE marques (
    ...
    designation_normalisee NVARCHAR(80) NOT NULL,
    ...
    CONSTRAINT uk_marques_designation_normalisee UNIQUE (designation_normalisee)
);
...
CREATE TABLE modeles (
    ...
    nom_normalise NVARCHAR(80) NOT NULL,
    date_creation DATETIME2 NOT NULL,
    cree_par NVARCHAR(100) NOT NULL,
    date_modification DATETIME2 NULL,
    modifie_par NVARCHAR(100) NULL,
    ...
    CONSTRAINT uk_modeles_marque_nom_normalise UNIQUE (marque_id, nom_normalise)
);
